...
#ifndef ANGMOMCONSERVATION_HPP_
#define ANGMOMCONSERVATION_HPP_
...
//! grid
template <class matter_t, class background_t> class AngMomConservation
{
  ...
  public:
    AngMomConservation(matter_t a_matter, background_t a_background,
