...
*/
class BoostedBHComplexProcaLevel : public GRAMRLevel
{
    friend class DefaultLevelFactory<BoostedBHComplexProcaLevel>;
    // Inherit the contructors from GRAMRLevel
    using GRAMRLevel::GRAMRLevel;

    // Typedef for proca field
    // typedef ComplexProcaField ComplexProcaField; //redundant?
