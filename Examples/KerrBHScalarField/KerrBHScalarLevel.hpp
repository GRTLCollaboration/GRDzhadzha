...
#ifndef KERRBHSCALARLEVEL_HPP_
#define KERRBHSCALARLEVEL_HPP_
...
*/
class KerrBHScalarLevel : public GRAMRLevel
{
    friend class DefaultLevelFactory<KerrBHScalarLevel>;
