...
#ifndef CCZ4SCALARFIELD_HPP_
#define CCZ4SCALARFIELD_HPP_
...
*/
template <class potential_t = DefaultPotential> class CCZ4ScalarField
{
  protected:
  ...
  public:
    //!  Constructor of class CCZ4ScalarField, inputs are the matter parameters.
    CCZ4ScalarField(const potential_t a_potential) : my_potential(a_potential)
    {
    }
...
#include "CCZ4ScalarField.impl.hpp"

#endif /* CCZ4SCALARFIELD_HPP_ */
