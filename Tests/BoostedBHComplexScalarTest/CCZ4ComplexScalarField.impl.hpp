...
#if !defined(CCZ4COMPLEXSCALARFIELD_HPP_)
#error "This file should only be included through CCZ4ComplexScalarField.hpp"
#endif

#ifndef CCZ4COMPLEXSCALARFIELD_IMPL_HPP_
#define CCZ4COMPLEXSCALARFIELD_IMPL_HPP_

// Calculate the stress energy tensor elements
template <class potential_t>
template <class data_t, template <typename> class vars_t>
emtensor_t<data_t> CCZ4ComplexScalarField<potential_t>::compute_emtensor(
...
template <class potential_t>
template <class data_t, template <typename> class vars_t>
void CCZ4ComplexScalarField<potential_t>::emtensor_excl_potential(
...
void CCZ4ComplexScalarField<potential_t>::add_matter_rhs(
...
template <class data_t, template <typename> class vars_t,
          template <typename> class diff2_vars_t,
          template <typename> class rhs_vars_t>
void CCZ4ComplexScalarField<potential_t>::matter_rhs_excl_potential(
...
#endif /* CCZ4COMPLEXSCALARFIELD_IMPL_HPP_ */
