...
*/
template <class potential_t = DefaultPotential> class CCZ4ComplexScalarField
{
  protected:
  ...
  public:
    //!  Constructor of class CCZ4ComplexScalarField, inputs are the matter
    //!  parameters.
    CCZ4ComplexScalarField(const potential_t a_potential)
...
#include "CCZ4ComplexScalarField.impl.hpp"

#endif /* CCZ4COMPLEXSCALARFIELD_HPP_ */
